package com.example.a12550071.exa_pract1_12550442;
...
public class Principal extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
    ...
    int puntos_para_pasar=70, calificacion=70;
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        if (puntos_para_pasar > calificacion){
            Toast miToast = Toast.makeText(this, "No aprobado", Toast.LENGTH_SHORT);
            miToast.show();
        } else {
            Toast miToast = Toast.makeText(this, "Aprobado", Toast.LENGTH_SHORT);
            miToast.show();
        }
    }
